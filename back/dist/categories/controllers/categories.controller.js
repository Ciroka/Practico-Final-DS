...
let CategoriesController = class CategoriesController {
    ...
    async findAll(page, limit) {
        if (page !== undefined && limit !== undefined)
            return await this.categoriesService.findAllPages(Number(page), Number(limit));
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_categories_dto_1.CreateCategory]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_categories_dto_1.UpdateCategory]),
    __metadata("design:returntype", Promise)
